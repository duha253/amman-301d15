...
// invoke properites associated with the constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//invoke DOM doument for window.
// 3. Explain why "this" is different when an arrow function is used.
//because the this value used in arrow functions is actually fetched lexically
//from the scope it sits inside. It has no this, so when you use this you’re talking to the outer scope.
