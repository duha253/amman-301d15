...
function displayPics(){
  ...
  //the previous line was error because when I changed var to let;
  //var is global variable we can use it any where in the code ;
  //let is a local variable we can't use it any where in the code ;
  console.log(viewed);
